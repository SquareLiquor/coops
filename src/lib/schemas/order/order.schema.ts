import type { AuthState, StoreEntity } from '$lib/types'
import type { CartData, CartItemData } from '$lib/types/common/ui/cart.state'
...
export const convertCartDataToOrderInput = (auth: AuthState, store: StoreEntity, data: CartData): OrderCreateInput => {
