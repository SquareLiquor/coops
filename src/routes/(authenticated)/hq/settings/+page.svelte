...
<div class="border-surface-100 flex h-16 items-center justify-between border-b px-6">
  <div class="flex items-center space-x-4">
    <h1 class="text-surface-900 text-2xl font-bold">본사 설정</h1>
  </div>
</div>
  ...
  {#if activeTab === 'general'}
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
          <label for="siteName" class="text-surface-700 mb-2 block text-sm font-medium">회사명</label>
          <input
            id="siteName"
            type="text"
        ...
        <div>
          <label for="adminEmail" class="text-surface-700 mb-2 block text-sm font-medium">본사 이메일</label>
          <input
            id="adminEmail"
            type="email"
        ...
        <div>
          <label for="contactPhone" class="text-surface-700 mb-2 block text-sm font-medium">본사 전화번호</label>
          <input
            id="contactPhone"
            type="tel"
        ...
        <div class="md:col-span-2">
          <label for="businessAddress" class="text-surface-700 mb-2 block text-sm font-medium">본사 주소</label>
          <input
            id="businessAddress"
            type="text"
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-surface-500 text-sm">새로운 발주, 가맹점 신청 등의 알림을 받습니다.</p>
          </div>
  ...
  {#if activeTab === 'orders'}
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div>
            <label for="minOrderAmount" class="text-surface-700 mb-2 block text-sm font-medium">최소 발주 금액</label>
            <input
              id="minOrderAmount"
              type="number"
          ...
          <div>
            <label for="maxOrderAmount" class="text-surface-700 mb-2 block text-sm font-medium">최대 발주 금액</label>
            <input
              id="maxOrderAmount"
              type="number"
